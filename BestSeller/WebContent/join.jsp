...
<body>
        ...
        <div class="card card-outline-secondary my-4">
          ...
          <div class="card-body">
            ...
            <div id="s2">
              ...
              <form name="myform" action="join.do" method="post"><!--this show forms.-->
                ...
                <input type="text" name="name" id="name" class="inpt" required="required" placeholder="Name"></br><br/>
                <input type="text" name="address" id="address" class="inpt" required="required" placeholder="Address"></br><br/>
                <input type="text" name="birth" id="birth" class="inpt" required="required" placeholder="Birth(YYMMDD)"></br><br/>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; BestSeller 2019</p>
    </div>
    <!-- /.container -->
  </footer>
