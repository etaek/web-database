...
<div class=box style="width:80%; height: 2200px; background-color:white; ">
    ...
    <div style="margin-left: 10%; margin-right: 30px;  height:300px; float: left; ">
        <table width=550>
            ...
            <tr>
                <td width=60>2011</td>
                <td width=400><img src=img2/g1.png id=chart0 width=0 height=40 align=absmiddle> 12.8</td>
            </tr>
            <tr >
                <td>2013</td>
                <td><img src=img2/g2.png id=chart1 width=0 height=40 align=absmiddle> 11.2</td>
            </tr>
            <tr>
                <td>2015</td>
                <td><img src=img2/g3.png id=chart2 width=0 height=40 align=absmiddle> 9.1</td>
            </tr>
            <tr>
                <td>2017</td>
                <td><img src=img2/g4.png id=chart3 width=0 height=40 align=absmiddle> 8.3</td>
            </tr>
        </table>
    </div>
    <br/>
    ...
    <div class="divImg">
        ...
        <img src="img2/giftbox.png" alt="gift_image" class="circleImg" data-aos="flip-left" class="front"/>
            </div><!--flip-box-front-->
        ...
        <div class="flip-box">
            <div class="flip-box-inner">
                <div class="flip-box-front">
                    <img src="img2/heart.png" alt="gift_image" class="circleImg" data-aos="flip-left" class="front"/>
                </div><!--flip-box-front-->
                <div class="flip-box-back">
        ...
        <div class="flip-box">
            <div class="flip-box-inner">
                <div class="flip-box-front">
                    <img src="img2/good.png" alt="gift_image" class="circleImg" data-aos="flip-left" class="front"/>
                </div><!--flip-box-front-->
                <div class="flip-box-back">
    ...
    <div class="team">
        <div class="teamMem"  style="float: left;">
            <img src="img2/ahyun.jpg" alt="mem_ahyun" class="memImg"/>
            <h2>Cheon Ahyun</h2>
            <a href="https://www.instagram.com/a_hyun1000" target="_blank"><img src="img2/instagram.png" alt="insta"/>&nbsp;&nbsp;</a>
            <a href="#emailCopy" class="emailCopy"><img src="img2/gmail.png" alt="mail"/>&nbsp;&nbsp;</a>
            <input type="text" value="cah0512@naver.com" id="emailAddress1" style="display:none;">
            <div id="contents" style=" display:inline;">
            <a href="#layerPopup"><img src="img2/phone.png" alt="phone"/>&nbsp;&nbsp;</a>
            <!--pop_up layer-->
            <div style="text-align:center;" id="layerPopup">
                <br/>
                <h2>010-6792-0512</h2>
                <br/>
                <button type="button" class="Xbtn"><img src="img2/error.png"></button>
            </div>
            </div>
            <!-- -->
        </div>
        ...
        <div class="teamMem" style="float: left;">
            <img src="img2/jh.jpg" alt="mem2" class="memImg"/>
            <h2>Kim Jeong Hoon</h2>
            <a href="https://www.instagram.com/hooonij" target="_blank"><img src="img2/instagram.png" alt="insta"/>&nbsp;&nbsp;</a>
            <a href="#emailCopy2" class="emailCopy2"><img src="img2/gmail.png" alt="mail"/>&nbsp;&nbsp;</a>
        ...
        <div class="teamMem" style="float: left;">
            <img src="img2/et.jpg" alt="mem3" class="memImg"/>
            <h2>Lee Eun Taek</h2>
            <a href="https://www.instagram.com/letoasis" target="_blank"><img src="img2/instagram.png" alt="insta"/>&nbsp;&nbsp;</a>
            <a href="#emailCopy3" class="emailCopy3"><img src="img2/gmail.png" alt="mail"/>&nbsp;&nbsp;</a>
