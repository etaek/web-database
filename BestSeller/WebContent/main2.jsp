    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="category.do">HOME</a></li>
                <li><a href="aboutUs.jsp">ABOUT US</a></li>
                <li><a href="Gift.jsp">GIFT</a></li>
                <li><a href="donate.do">DONATION</a></li>
                <li><a href="recommend.do">RECOMMENDED</a></li>
                <li><a href="myinfo.do">MYINFO</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="height: 900px">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item" style="height: 900px">
            <img src="img2/slide3.jpg" height="700px">
            <div class="carousel-caption">
        ...
        <div class="item" style="height: 900px">
            <img src="img2/slide4.jpg" height="700px">
            <div class="carousel-caption">
        ...
        <div class="item" style="height: 900px">
            <img src="img2/slide5.jpg" height="700px">
            <div class="carousel-caption">
...
<div id="band" class="container text-center">
    ...
    <p><em>What a exciting event!</em></p>
        ...
        <div class="regular slider">
            <div><img src="img2/book1.jpg" class="bi"></div>
            <div><img src="img2/book2.jpg" class="bi"></div>
            <div><img src="img2/book3.jpg" class="bi"></div>
            <div><img src="img2/book4.jpg" class="bi"></div>
            <div><img src="img2/book5.jpg" class="bi"></div>
            <div><img src="img2/book6.jpg" class="bi"></div>
            <div><img src="img2/book7.jpg" class="bi"></div>
            <div><img src="img2/book8.jpg" class="bi"></div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-sm-4" data-aos="flip-up">
                <div class="thumbnail">
                    <img src="img2/bookex.png" alt="bookes.png" width="400" height="300" style="padding-top: 40px; padding-bottom: 45px;">
            ...
            <div class="col-sm-4" data-aos="flip-up">
                <div class="thumbnail">
                    <img src="img2/donateIntro.png" alt="donation.png" width="400" height="300" style="padding-top: 30px; padding-bottom:8px;">
            ...
            <div class="col-sm-4" data-aos="flip-up">
                <div class="thumbnail">
                    <img src="img2/recommend.png" alt="recommend" width="400" height="300">
            ...
            <div class="col-sm-6 form-group">
                <select class="form-control" id="select" name="select" required>
                    <c:forEach items="${articleList}" var="article">
               			<option value= "${article.cnum}">${article.ctitle}</option>
             		</c:forEach>  
